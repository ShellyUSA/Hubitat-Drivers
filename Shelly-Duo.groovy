...
try {
    httpGet(params1) {
       ...
       // def each state 
        ...
        sendEvent(name: "colorTemperature", value: obs1.lights.temp[0])
...
try {
    httpGet(params) {
        ...
        sendEvent(name: "colorTemperature", value: obs.lights.temp[0])
...
def setLevel(percent) {
        ...
        if (txtEnable) log.info ("setLevel(x): transition time = ${transTime}")
}
...
def setColorTemperature(colortemperature) {
    sendLevelCommand "temp=${colortemperature}"
}
