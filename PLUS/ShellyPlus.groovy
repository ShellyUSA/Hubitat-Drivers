 ...
 *
 *  Changes:
 *  1.0.2 - Change driver name to Shelly Plus
 *        - Added Eco Mode status
...
metadata {
	definition (
		...
		author: "Scott Grayban",
                importUrl: "https://raw.githubusercontent.com/ShellyUSA/Hubitat-Drivers/master/PLUS/ShellyPlus.groovy"
		)
	{
        capability "Actuator"
        capability "Sensor"
