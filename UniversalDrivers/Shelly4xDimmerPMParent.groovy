/**
 * Shelly Autoconf 4x Dimmer PM Parent
 *
 * Parent driver for 4-channel dimmer Shelly devices with power monitoring.
 * Examples: Shelly Plus RGBW PM (light profile), Shelly Pro RGBWW PM (light profile)
 *
 * Architecture:
 *   - App creates parent device with component data values
 *   - Parent creates 4 dimmer children as driver-level children in initialize()
...
metadata {
  definition(name: 'Shelly Autoconf 4x Dimmer PM Parent', namespace: 'ShellyDeviceManager', author: 'Daniel Winks', singleThreaded: false, importUrl: '') {
    capability 'Light'
 ...
 * Expected: 4 dimmer children, 0-4 input children.
 */
