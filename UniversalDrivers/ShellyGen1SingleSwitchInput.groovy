/**
 * Shelly Gen1 Single Switch Input
 *
 * Pre-built standalone driver for Gen 1 single-relay Shelly devices with an input terminal.
 * Examples: Shelly 1 (SHSW-1)
 *
 * Extends the base single switch driver with PushableButton and HoldableButton capabilities.
...
metadata {
  definition(name: 'Shelly Gen1 Single Switch Input', namespace: 'ShellyDeviceManager', author: 'Daniel Winks', singleThreaded: false, importUrl: '') {
    capability 'Switch'
 ...
 * Handles switch state changes and input button events (short/long press).
 *
