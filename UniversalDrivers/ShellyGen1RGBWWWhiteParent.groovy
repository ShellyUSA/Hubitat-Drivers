/**
 * Shelly Gen1 RGBWW White Parent (SHRGBWW-01 in white firmware mode)
 *
 * Parent driver for the Shelly RGBWW when configured in white mode.
...
metadata {
  definition(name: 'Shelly Gen1 RGBWW White Parent', namespace: 'ShellyDeviceManager', author: 'Daniel Winks', singleThreaded: false, importUrl: '') {
    capability 'Switch'
 ...
 * Expected: 4 white channel children for the RGBWW in white mode.
 */
