/**
 * Shelly Autoconf Temperature Peripheral - Component Driver
 *
 * Self-contained component driver for Shelly external temperature sensor peripherals.
 * Receives temperature readings pushed from the parent device.
 */
