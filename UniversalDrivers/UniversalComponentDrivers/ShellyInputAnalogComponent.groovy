/**
 * Shelly Autoconf Input Analog - Component Driver
 *
 * Self-contained component driver for Shelly analog input components.
 * Receives analog value updates pushed from the parent device.
 */
import groovy.transform.Field

metadata {
  definition (name: 'Shelly Autoconf Input Analog', namespace: 'ShellyDeviceManager', author: 'Daniel Winks', singleThreaded: false, importUrl: '') {
    capability 'Sensor'
    capability 'Refresh'
