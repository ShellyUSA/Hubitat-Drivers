/**
 * Shelly Autoconf Humidity Peripheral - Component Driver
 *
 * Self-contained component driver for Shelly external humidity sensor peripherals.
 * Receives humidity readings pushed from the parent device.
 */
