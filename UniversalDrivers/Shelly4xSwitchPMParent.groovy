/**
 * Shelly Autoconf 4x Switch PM Parent
 *
 * Parent driver for quad-switch Shelly devices with power monitoring.
 * Examples: Shelly Pro 4PM (SPSW-104PE16EU)
 *
 * Architecture:
 ...
 * All values are stringified for compatibility with buildWebhookEvents.
 *
