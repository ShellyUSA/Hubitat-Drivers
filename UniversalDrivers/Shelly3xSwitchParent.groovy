/**
 * Shelly Autoconf 3x Switch Parent
 *
 * Parent driver for triple-switch Shelly devices without power monitoring.
 * Examples: Shelly Pro 3
 *
 * Architecture:
 *   - App creates parent device with component data values
 *   - Parent creates 3 switch children as driver-level children in initialize()
...
metadata {
  definition(name: 'Shelly Autoconf 3x Switch Parent', namespace: 'ShellyDeviceManager', author: 'Daniel Winks', singleThreaded: false, importUrl: '') {
    capability 'Switch'
 ...
 * Expected: up to 3 switch children (no PM), 0-3 input children.
 */
