 ...
 * Shelly BLU Distance
 *
 * Standalone driver for Shelly BLU Distance (SBDI-003E) Bluetooth ultrasonic
 * distance sensor. Reports raw distance in millimeters plus battery and BLE
 * radio presence. Receives events from the Shelly Device Manager app via BLE
 * gateway relay.
 *
...
metadata {
  definition(name: 'Shelly BLU Distance', namespace: 'ShellyDeviceManager', author: 'Daniel Winks', singleThreaded: false, importUrl: '') {
    capability 'Battery'
