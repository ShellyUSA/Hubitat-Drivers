 ...
 *
 * Standalone driver for Shelly BLU Door/Window (SBDW-002C) Bluetooth
 * contact sensor. Reports open/close state, illuminance, tilt angle,
 * and battery level. Receives events from the Shelly Device Manager app
