 ...
 * Shelly Gen1 Plug
 *
 * Pre-built standalone driver for the Gen 1 Shelly Plug (SHPLG-1).
 * Provides switch control and power monitoring (power, voltage, energy, computed amperage).
...
metadata {
  definition(name: 'Shelly Gen1 Plug', namespace: 'ShellyDeviceManager', author: 'Daniel Winks', singleThreaded: false, importUrl: '') {
    capability 'Switch'
