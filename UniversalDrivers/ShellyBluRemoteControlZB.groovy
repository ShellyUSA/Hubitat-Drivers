 ...
 *
 * Standalone driver for Shelly BLU Remote Control ZB (SBRC-005B) Bluetooth
 * remote. Exposes two raw button slots via Hubitat button capabilities plus
 * raw channel, dimmer, and rotation values from BLE advertisements. Receives
 * events from the Shelly Device Manager app via BLE gateway relay.
 *
...
metadata {
  definition(name: 'Shelly BLU Remote Control ZB', namespace: 'ShellyDeviceManager', author: 'Daniel Winks', singleThreaded: false, importUrl: '') {
    ...
    attribute 'rawChannel', 'number'
    attribute 'rawDimmer', 'number'
    attribute 'rawRotation1', 'number'
    attribute 'rawRotation2', 'number'
    attribute 'rawRotation3', 'number'
